...
export const SERVICES_DETAILS = [
  ...
  },
  {
    ...
    description: `Our team collaborates closely with all stakeholders to ensure that the project meets all standards and is completed on time and within budget.
      ...
      Our project managers are experienced professionals who are dedicated to delivering quality results and ensuring client satisfaction.`
  },
  {
    id: 3,
    ...
    description: `We offer tailored solutions to meet specific project needs, ensuring efficient and effective execution.
      ...
      Our goal is to help clients achieve their construction objectives and deliver successful projects on time and within budget.`
  }
];
